...
**Chain**:
A causal failure unit: an originating task plus all its fix-task descendants plus every task transitively blocked behind that set; the unit of collapse for the Action queue.
