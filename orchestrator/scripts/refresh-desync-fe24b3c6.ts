// Self-heal artifact for task fe24b3c6 (re-confirmation pass).
//
...
//   git rev-list --left-right --count main...task/fe24b3c6 → "38  0"
//
...
//   - sqlite3 .mars/state.db inbox_items LIKE '%fe24b3c6%' → 1 open item
