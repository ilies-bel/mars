 ...
 * tries the 2-token path ('task add') first, then the 1-token path ('where').
 * The matched {@link Command} plus the remaining positionals are returned;
 * dispatch and exit-mapping live in the adapters.
 */
