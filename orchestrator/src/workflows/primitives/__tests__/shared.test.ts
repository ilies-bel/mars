...
// ---------------------------------------------------------------------------
// COMPLETION_REPORT_CONTRACT — pre-existing UNVERIFIED fallback
// ---------------------------------------------------------------------------

describe('COMPLETION_REPORT_CONTRACT — pre-existing-failure fallback', () => {
  it('mentions "pre-existing UNVERIFIED" so completion-report shape matches Rule 6', () => {
    expect(COMPLETION_REPORT_CONTRACT).toContain('pre-existing UNVERIFIED')
  })
})
